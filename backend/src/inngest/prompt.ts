...
// ============================================================================
// COMMON SECTIONS - Shared between PROMPT and CODE_EDITOR_PROMPT
// ============================================================================

const COMMON_ENVIRONMENT = `Environment:
...
- You MUST NOT create or modify any .css, .scss, globals.css or .sass files — styling must be done strictly using Tailwind CSS classes
...
const COMMON_FILE_SAFETY_RULES = `File Safety Rules:
- ALWAYS add "use client" to the TOP, THE FIRST LINE of app/page.tsx and any other relevant files which use browser APIs or react hooks`;

const COMMON_RUNTIME_RULES = `Runtime Execution (Strict Rules):
...
const COMMON_SHADCN_USAGE = `Shadcn UI dependencies — including radix-ui, lucide-react, class-variance-authority, and tailwind-merge — are already installed and must NOT be installed again. Tailwind CSS and its plugins are also preconfigured. Everything else requires explicit installation.
...
const COMMON_GUIDELINES = `Additional Guidelines:
...
const COMMON_FILE_CONVENTIONS = `File conventions:
- Write new components directly into app/ and split reusable logic into separate files where appropriate
- Use PascalCase for component names, kebab-case for filenames
- Use .tsx for components, .ts for types/utilities
- Components should be using named exports`;

const COMMON_FINAL_OUTPUT = `Final output (MANDATORY):
